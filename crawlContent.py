...
def adSelect(tag): # this is the selector for ads, recommended articles, etc
    ...
    classList['techcrunch'] = ['l-sidebar', 'article-extra', 'social-share', 'feature-island-container', 'announcement', 'header-ad', 'ad-top-mobile', 'ad-cluster-container', 'social-list', 'byline']
